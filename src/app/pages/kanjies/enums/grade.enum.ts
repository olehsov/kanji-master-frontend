export const Grade: { [key: string]: string } = {
    Hyogaiji: 'Hyōgaiji',
    HyogaijiFormerJinmeiyoCandidate: 'Hyōgaiji (former Jinmeiyō candidate)',
    HyogaijiFormerJoyoCandidate: 'Hyōgaiji (former Jōyō candidate)',
    HyogaijiToleratedJoyoVariant: 'Hyōgaiji (tolerated Jōyō variant)',
